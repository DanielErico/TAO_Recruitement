              ...
              <table className="data-table w-full text-left">
                ...
                <tbody className="divide-y divide-[var(--color-border)]">
                  {candidates.map((candidate: any) => {
                    ...
                    return (
                      <tr key={candidate.id} className="hover:bg-[var(--color-muted)]/10 transition-colors">
                        <td className="px-5 py-4 font-semibold text-sm text-[var(--color-foreground)]">
                          {candidate.full_name || "Unspecified"}
                        </td>
                        <td className="px-5 py-4 text-sm text-[var(--color-muted-foreground)] flex items-center gap-1.5 mt-1">
                          <Mail size={13} />
                          {candidate.email}
                        </td>
